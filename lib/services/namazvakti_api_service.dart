...
class NamazVaktiApiService {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decoded is List) {
          ...
          final vakitler = decoded.where((v) {
          ...
          if (vakitler.isNotEmpty) {
            print('✅ Yedek API: ${vakitler.length} günlük veri');
            return vakitler;
          }
        }
      }
    } catch (e) {
      print('⚠️ Yedek API aylık vakit hatası: $e');
    }
  ...
  static void clearCache() {
    _cache.clear();
    _cacheTimes.clear();
    print('✅ Yedek API cache temizlendi');
  }
}
